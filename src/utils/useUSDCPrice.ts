import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '../constants/uniswap'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.TESTNET ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.TESTNET ? USDC : undefined]
    ],
